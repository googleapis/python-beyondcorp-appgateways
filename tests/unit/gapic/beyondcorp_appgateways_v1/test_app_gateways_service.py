...
from google.cloud.beyondcorp_appgateways_v1.services.app_gateways_service import (
...
def test__get_default_mtls_endpoint():
    ...
    assert (
        AppGatewaysServiceClient._get_default_mtls_endpoint(api_endpoint)
        == api_mtls_endpoint
    )
    assert (
        AppGatewaysServiceClient._get_default_mtls_endpoint(api_mtls_endpoint)
        == api_mtls_endpoint
    )
    assert (
        AppGatewaysServiceClient._get_default_mtls_endpoint(sandbox_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        AppGatewaysServiceClient._get_default_mtls_endpoint(sandbox_mtls_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        AppGatewaysServiceClient._get_default_mtls_endpoint(non_googleapi)
        == non_googleapi
    )
...
@pytest.mark.parametrize(
    ...
    [
        (AppGatewaysServiceClient, "grpc"),
        (AppGatewaysServiceAsyncClient, "grpc_asyncio"),
        (AppGatewaysServiceClient, "rest"),
    ],
)
def test_app_gateways_service_client_from_service_account_info(
    client_class, transport_name
):
...
@pytest.mark.parametrize(
    ...
    [
        (transports.AppGatewaysServiceGrpcTransport, "grpc"),
        (transports.AppGatewaysServiceGrpcAsyncIOTransport, "grpc_asyncio"),
        (transports.AppGatewaysServiceRestTransport, "rest"),
    ],
)
def test_app_gateways_service_client_service_account_always_use_jwt(
    transport_class, transport_name
):
    with mock.patch.object(
...
def test_app_gateways_service_client_from_service_account_file(
    client_class, transport_name
):
    creds = ga_credentials.AnonymousCredentials()
    with mock.patch.object(
...
def test_app_gateways_service_client_get_transport_class():
    ...
    available_transports = [
        transports.AppGatewaysServiceGrpcTransport,
        transports.AppGatewaysServiceRestTransport,
    ]
...
@pytest.mark.parametrize(
    ...
    [
        (AppGatewaysServiceClient, transports.AppGatewaysServiceGrpcTransport, "grpc"),
        (
            AppGatewaysServiceAsyncClient,
            transports.AppGatewaysServiceGrpcAsyncIOTransport,
            "grpc_asyncio",
        ),
        (AppGatewaysServiceClient, transports.AppGatewaysServiceRestTransport, "rest"),
    ],
)
@mock.patch.object(
    AppGatewaysServiceClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(AppGatewaysServiceClient),
)
@mock.patch.object(
    AppGatewaysServiceAsyncClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(AppGatewaysServiceAsyncClient),
)
def test_app_gateways_service_client_client_options(
    client_class, transport_class, transport_name
):
...
def test_app_gateways_service_client_mtls_env_auto(
    client_class, transport_class, transport_name, use_client_cert_env
):
...
def test_app_gateways_service_client_client_options_scopes(
    client_class, transport_class, transport_name
):
...
def test_app_gateways_service_client_client_options_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
...
def test_app_gateways_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.beyondcorp_appgateways_v1.services.app_gateways_service.transports.AppGatewaysServiceGrpcTransport.__init__"
    ) as grpc_transport:
        grpc_transport.return_value = None
        client = AppGatewaysServiceClient(
...
def test_list_app_gateways(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(
        type(client.transport.list_app_gateways), "__call__"
    ) as call:
...
@pytest.mark.asyncio
async def test_list_app_gateways_async(
    transport: str = "grpc_asyncio",
    request_type=app_gateways_service.ListAppGatewaysRequest,
):
    client = AppGatewaysServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
async def test_list_app_gateways_flattened_async():
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.list_app_gateways(
            parent="parent_value",
        )
...
async def test_list_app_gateways_flattened_error_async():
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.list_app_gateways(
            app_gateways_service.ListAppGatewaysRequest(),
            parent="parent_value",
        )
...
async def test_list_app_gateways_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client.transport.list_app_gateways),
        "__call__",
        ...
        async_pager = await client.list_app_gateways(
            request={},
        )
...
def test_get_app_gateway(request_type, transport: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.get_app_gateway), "__call__") as call:
        ...
        call.return_value = app_gateways_service.AppGateway(
            ...
            uid="uid_value",
            type_=app_gateways_service.AppGateway.Type.TCP_PROXY,
...
@pytest.mark.asyncio
async def test_get_app_gateway_async(
    transport: str = "grpc_asyncio",
    request_type=app_gateways_service.GetAppGatewayRequest,
):
    client = AppGatewaysServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
async def test_get_app_gateway_flattened_async():
    ...
    with mock.patch.object(type(client.transport.get_app_gateway), "__call__") as call:
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.get_app_gateway(
            name="name_value",
        )
...
def test_create_app_gateway(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client.transport.create_app_gateway), "__call__"
    ) as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_create_app_gateway_async(
    transport: str = "grpc_asyncio",
    request_type=app_gateways_service.CreateAppGatewayRequest,
):
    client = AppGatewaysServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_create_app_gateway_flattened():
    ...
    with mock.patch.object(
        ...
        client.create_app_gateway(
            parent="parent_value",
            app_gateway=app_gateways_service.AppGateway(name="name_value"),
            app_gateway_id="app_gateway_id_value",
        )
...
async def test_create_app_gateway_flattened_async():
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.create_app_gateway(
            parent="parent_value",
            app_gateway=app_gateways_service.AppGateway(name="name_value"),
            app_gateway_id="app_gateway_id_value",
        )
...
async def test_create_app_gateway_flattened_error_async():
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.create_app_gateway(
            app_gateways_service.CreateAppGatewayRequest(),
            parent="parent_value",
            app_gateway=app_gateways_service.AppGateway(name="name_value"),
            app_gateway_id="app_gateway_id_value",
...
def test_delete_app_gateway(request_type, transport: str = "grpc"):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client.transport.delete_app_gateway), "__call__"
    ) as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name="operations/spam")
...
@pytest.mark.asyncio
async def test_delete_app_gateway_async(
    transport: str = "grpc_asyncio",
    request_type=app_gateways_service.DeleteAppGatewayRequest,
):
    client = AppGatewaysServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
async def test_delete_app_gateway_flattened_async():
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.delete_app_gateway(
            name="name_value",
        )
...
async def test_delete_app_gateway_flattened_error_async():
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.delete_app_gateway(
            app_gateways_service.DeleteAppGatewayRequest(),
            name="name_value",
        )
...
def test_list_app_gateways_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        pb_return_value = app_gateways_service.ListAppGatewaysResponse.pb(return_value)
...
def test_list_app_gateways_rest_required_fields(
    request_type=app_gateways_service.ListAppGatewaysRequest,
):
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).list_app_gateways._get_unset_required_fields(jsonified_request)
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            pb_return_value = app_gateways_service.ListAppGatewaysResponse.pb(
                return_value
            )
            json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_list_app_gateways_rest_unset_required_fields():
    transport = transports.AppGatewaysServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials
    )
...
def test_list_app_gateways_rest_interceptors(null_interceptor):
    transport = transports.AppGatewaysServiceRestTransport(
        ...
        interceptor=None
        if null_interceptor
        else transports.AppGatewaysServiceRestInterceptor(),
    )
    ...
    with mock.patch.object(
        ...
        req.return_value._content = (
            app_gateways_service.ListAppGatewaysResponse.to_json(
                app_gateways_service.ListAppGatewaysResponse()
            )
        )
...
def test_list_app_gateways_rest_bad_request(
    transport: str = "rest", request_type=app_gateways_service.ListAppGatewaysRequest
):
    client = AppGatewaysServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_list_app_gateways_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1/{parent=projects/*/locations/*}/appGateways"
...
def test_list_app_gateways_rest_pager(transport: str = "rest"):
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        response = tuple(
            app_gateways_service.ListAppGatewaysResponse.to_json(x) for x in response
        )
...
def test_get_app_gateway_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = app_gateways_service.AppGateway.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_get_app_gateway_rest_required_fields(
    request_type=app_gateways_service.GetAppGatewayRequest,
):
    transport_class = transports.AppGatewaysServiceRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).get_app_gateway._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_app_gateway_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = app_gateways_service.AppGateway.to_json(
            app_gateways_service.AppGateway()
        )
...
def test_get_app_gateway_rest_bad_request(
    transport: str = "rest", request_type=app_gateways_service.GetAppGatewayRequest
):
    client = AppGatewaysServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_get_app_gateway_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {
            "name": "projects/sample1/locations/sample2/appGateways/sample3"
        }
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{name=projects/*/locations/*/appGateways/*}"
            % client.transport._host,
            args[1],
        )
...
def test_create_app_gateway_rest_required_fields(
    request_type=app_gateways_service.CreateAppGatewayRequest,
):
    transport_class = transports.AppGatewaysServiceRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).create_app_gateway._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_app_gateway_rest_bad_request(
    transport: str = "rest", request_type=app_gateways_service.CreateAppGatewayRequest
):
    client = AppGatewaysServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_delete_app_gateway_rest_required_fields(
    request_type=app_gateways_service.DeleteAppGatewayRequest,
):
    transport_class = transports.AppGatewaysServiceRestTransport
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).delete_app_gateway._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_app_gateway_rest_bad_request(
    transport: str = "rest", request_type=app_gateways_service.DeleteAppGatewayRequest
):
    client = AppGatewaysServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
...
def test_credentials_transport_error():
    ...
    transport = transports.AppGatewaysServiceGrpcTransport(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    with pytest.raises(ValueError):
        client = AppGatewaysServiceClient(
...
def test_transport_get_channel():
    ...
    transport = transports.AppGatewaysServiceGrpcAsyncIOTransport(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    channel = transport.grpc_channel
    assert channel
...
def test_transport_kind(transport_name):
    transport = AppGatewaysServiceClient.get_transport_class(transport_name)(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_app_gateways_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.beyondcorp_appgateways_v1.services.app_gateways_service.transports.AppGatewaysServiceTransport.__init__"
    ) as Transport:
...
def test_app_gateways_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.beyondcorp_appgateways_v1.services.app_gateways_service.transports.AppGatewaysServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
...
@pytest.mark.parametrize(
    ...
    [
        (transports.AppGatewaysServiceGrpcTransport, grpc_helpers),
        (transports.AppGatewaysServiceGrpcAsyncIOTransport, grpc_helpers_async),
    ],
)
...
def test_app_gateways_service_grpc_transport_client_cert_source_for_mtls(
    transport_class,
):
...
def test_app_gateways_service_client_transport_session_collision(transport_name):
    ...
    client1 = AppGatewaysServiceClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = AppGatewaysServiceClient(
        credentials=creds2,
        transport=transport_name,
    )
...
def test_app_gateways_service_transport_channel_mtls_with_client_cert_source(
    transport_class,
):
    with mock.patch(
...
def test_app_gateway_path():
    ...
    app_gateway = "whelk"
    expected = (
        "projects/{project}/locations/{location}/appGateways/{app_gateway}".format(
            project=project,
            location=location,
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(
        transports.AppGatewaysServiceTransport, "_prep_wrapped_messages"
    ) as prep:
        client = AppGatewaysServiceClient(
            credentials=ga_credentials.AnonymousCredentials(),
...
@pytest.mark.parametrize(
    ...
    [
        (AppGatewaysServiceClient, transports.AppGatewaysServiceGrpcTransport),
        (
            AppGatewaysServiceAsyncClient,
            transports.AppGatewaysServiceGrpcAsyncIOTransport,
        ),
