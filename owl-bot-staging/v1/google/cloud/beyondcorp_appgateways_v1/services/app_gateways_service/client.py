...
from .transports.grpc import AppGatewaysServiceGrpcTransport
from .transports.grpc_asyncio import AppGatewaysServiceGrpcAsyncIOTransport
from .transports.rest import AppGatewaysServiceRestTransport


class AppGatewaysServiceClientMeta(type):
    """Metaclass for the AppGatewaysService client.
...
class AppGatewaysServiceClient(metaclass=AppGatewaysServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            AppGatewaysServiceClient: The constructed client.
        """
    ...
    def transport(self) -> AppGatewaysServiceTransport:
        ...
        Returns:
            AppGatewaysServiceTransport: The transport used by the client
                instance.
        """
        return self._transport

    @staticmethod
    def app_gateway_path(project: str,location: str,app_gateway: str,) -> str:
        """Returns a fully-qualified app_gateway string."""
        return "projects/{project}/locations/{location}/appGateways/{app_gateway}".format(project=project, location=location, app_gateway=app_gateway, )

    @staticmethod
    def parse_app_gateway_path(path: str) -> Dict[str,str]:
        """Parses a app_gateway path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/appGateways/(?P<app_gateway>.+?)$", path)
    ...
    def __init__(self, *,
        ...
        if isinstance(transport, AppGatewaysServiceTransport):
            # transport is a AppGatewaysServiceTransport instance.
    ...
    def list_app_gateways(self,
        ...
        Returns:
            google.cloud.beyondcorp_appgateways_v1.services.app_gateways_service.pagers.ListAppGatewaysPager:
        ...
        # in a app_gateways_service.ListAppGatewaysRequest.
        ...
        rpc = self._transport._wrapped_methods[self._transport.list_app_gateways]
        ...
        response = pagers.ListAppGatewaysPager(
            method=rpc,
            request=request,
            response=response,
            metadata=metadata,
    ...
    def get_app_gateway(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a app_gateways_service.GetAppGatewayRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_app_gateway]
    ...
    def create_app_gateway(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a app_gateways_service.CreateAppGatewayRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_app_gateway]
    ...
    def delete_app_gateway(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a app_gateways_service.DeleteAppGatewayRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_app_gateway]
