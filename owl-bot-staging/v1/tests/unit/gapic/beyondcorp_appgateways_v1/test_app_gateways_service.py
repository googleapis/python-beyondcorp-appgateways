...
from google.cloud.beyondcorp_appgateways_v1.services.app_gateways_service import AppGatewaysServiceAsyncClient
from google.cloud.beyondcorp_appgateways_v1.services.app_gateways_service import AppGatewaysServiceClient
from google.cloud.beyondcorp_appgateways_v1.services.app_gateways_service import pagers
from google.cloud.beyondcorp_appgateways_v1.services.app_gateways_service import transports
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (AppGatewaysServiceAsyncClient, transports.AppGatewaysServiceGrpcAsyncIOTransport, "grpc_asyncio"),
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (AppGatewaysServiceClient, transports.AppGatewaysServiceGrpcTransport, "grpc", "true"),
    (AppGatewaysServiceAsyncClient, transports.AppGatewaysServiceGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (AppGatewaysServiceClient, transports.AppGatewaysServiceGrpcTransport, "grpc", "false"),
    (AppGatewaysServiceAsyncClient, transports.AppGatewaysServiceGrpcAsyncIOTransport, "grpc_asyncio", "false"),
    (AppGatewaysServiceClient, transports.AppGatewaysServiceRestTransport, "rest", "true"),
    (AppGatewaysServiceClient, transports.AppGatewaysServiceRestTransport, "rest", "false"),
])
@mock.patch.object(AppGatewaysServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(AppGatewaysServiceClient))
@mock.patch.object(AppGatewaysServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(AppGatewaysServiceAsyncClient))
...
@pytest.mark.parametrize("client_class", [
    AppGatewaysServiceClient, AppGatewaysServiceAsyncClient
])
@mock.patch.object(AppGatewaysServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(AppGatewaysServiceClient))
@mock.patch.object(AppGatewaysServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(AppGatewaysServiceAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (AppGatewaysServiceClient, transports.AppGatewaysServiceGrpcTransport, "grpc", grpc_helpers),
    (AppGatewaysServiceAsyncClient, transports.AppGatewaysServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (AppGatewaysServiceClient, transports.AppGatewaysServiceRestTransport, "rest", None),
])
...
def test_list_app_gateways_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, app_gateways_service.AppGateway)
                   for i in results)
...
async def test_list_app_gateways_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_app_gateways(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_get_app_gateway(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_app_gateway),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_app_gateway(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_app_gateway),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_delete_app_gateway(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_app_gateway),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_list_app_gateways_rest_interceptors(null_interceptor):
    transport = transports.AppGatewaysServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.AppGatewaysServiceRestInterceptor(),
        )
    client = AppGatewaysServiceClient(transport=transport)
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.AppGatewaysServiceRestInterceptor, "post_list_app_gateways") as post, \
         mock.patch.object(transports.AppGatewaysServiceRestInterceptor, "pre_list_app_gateways") as pre:
...
def test_get_app_gateway_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.AppGatewaysServiceRestInterceptor, "post_get_app_gateway") as post, \
         mock.patch.object(transports.AppGatewaysServiceRestInterceptor, "pre_get_app_gateway") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_app_gateway_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.AppGatewaysServiceRestInterceptor, "post_create_app_gateway") as post, \
         mock.patch.object(transports.AppGatewaysServiceRestInterceptor, "pre_create_app_gateway") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_app_gateway_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.AppGatewaysServiceRestInterceptor, "post_delete_app_gateway") as post, \
         mock.patch.object(transports.AppGatewaysServiceRestInterceptor, "pre_delete_app_gateway") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.AppGatewaysServiceGrpcTransport, transports.AppGatewaysServiceGrpcAsyncIOTransport])
def test_app_gateways_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
@pytest.mark.parametrize("client_class,transport_class", [
    ...
    (AppGatewaysServiceAsyncClient, transports.AppGatewaysServiceGrpcAsyncIOTransport),
])
